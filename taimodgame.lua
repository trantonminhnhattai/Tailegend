...
shared.LoaderTitle = "đăng kí kênh tài mod game ";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=103985507475473";
v24.Parent = v23;
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    ...
    Description = "turn on haki castle on the sea ",
    Default = false
});
...
if Sea3 then
    ...
    v16.Main:AddButton({
        Title = "Thử Vận May",
        Description = "try luck in castle",
        Callback = function()
            local v573 = {
                [1] = "gravestoneEvent",
                [2] = 2
...
if Sea2 then
    ...
    local v497 = v16.Main:AddToggle("ToggleVatChatKiDi", {
        ...
        Description = "auto farm ectoplasm",
        Default = false
    });
...
if Sea3 then
    ...
    local v500 = v16.Sea:AddToggle("ToggleEspKitsune", {
        ...
        Description = "positioning kitsune island",
        Default = false
    });
    ...
    local v502 = v16.Sea:AddToggle("ToggleCollectAzure", {
        ...
        Description = "gets blue soul in kitsune island",
        Default = false
    });
...
v16.Sea:AddButton({
    ...
    Description = "Change blue Soul in kitsune island",
    Callback = function()
...
if Sea3 then
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        ...
        Description = "drive ship back to tiki",
        Default = false
    });
    ...
    v16.Sea:AddButton({
        ...
        Description = "teleport to huting area",
        Callback = function()
    ...
    local v519 = v16.Sea:AddDropdown("DropdownBoat", {
        ...
        Description = "choose ship to buy",
        Values = v518,
        Multi = false,
        Default = 1
    });
    ...
    local v523 = v16.Sea:AddToggle("TogglePiranha", {
        Title = "Đấm Piranha",
        Description = "farm island piranha",
        Default = false
    });
    ...
    local v526 = v16.Sea:AddToggle("ToggleShip", {
        Title = "Đấm Tàu",
        Description = "farm ship in sea event",
        Default = false
    });
    ...
    local v527 = v16.Sea:AddToggle("ToggleGhostShip", {
        Title = "Đấm Tàu Ma",
        Description = "farm ghost ship in sea event",
        Default = false
    });
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://14069216114") then
                    return v729;
                end
            end
        end
...
local v75 = v16.ITM:AddToggle("ToggleAutoCanvander", {
    ...
    Description = "get quest for doing get it canvander",
    Default = false
});
...
local v76 = v16.ITM:AddToggle("ToggleAutoMusketeerHat", {
    ...
    Description = "get quest for doing get it Musketeers hat",
    Default = false
});
...
if Sea2 then
    local v539 = v16.Main:AddToggle("ToggleSwordLengend", {
        ...
        Description = "buy legendary sword in sea 2",
        Default = false
    });
...
local v88 = v16.Setting:AddToggle("ToggleSaveSpawn", {
    ...
    Description = "Save Revive Points ",
    Default = false
});
...
local v107 = v16.Stats:AddToggle("ToggleMelee", {
    ...
    Description = "choose upgrade stats melee",
    Default = false
});
...
local v108 = v16.Stats:AddToggle("ToggleDe", {
    Title = "Nâng điểm Máu",
    Description = "choose upgrade stats defense",
    Default = false
});
...
local v109 = v16.Stats:AddToggle("ToggleSword", {
    ...
    Description = "choose upgrade stats sword",
    Default = false
});
...
local v110 = v16.Stats:AddToggle("ToggleGun", {
    Title = "Nâng Súng",
    Description = "choose upgrade stats gun",
    Default = false
});
...
local v111 = v16.Stats:AddToggle("ToggleFruit", {
    ...
    Description = "choose upgrade stats fruit",
    Default = false
});
...
local v115 = v16.Player:AddToggle("ToggleNoClip", {
    ...
    Description = "Going Through Walls",
    Default = true
});
...
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    ...
    Description = "auto doing quest to join second sea",
    Default = false
});
...
local v120 = v16.Teleport:AddToggle("ToggleAutoSea3", {
    ...
    Description = "auto doing quest for join third sea",
    Default = false
});
...
local v121 = v16.Teleport:AddDropdown("DropdownIsland", {
    ...
    Description = "choose island for teleport",
    Values = IslandList,
    Multi = false,
    Default = 1
});
...
local v123 = v16.Fruit:AddDropdown("DropdownFruit", {
    ...
    Description = "choose fruit to buy",
...
local v111 = v16.Fruit:AddToggle("ToggleFruit", {
    ...
    Description = "buy fruit in stock choose (if it stock in shop)",
    Default = false
});
...
local v124 = v16.Fruit:AddDropdown("DropdownPermanentFruit", {
    ...
    Description = "choose premium fruit (if you have in shop)",
    Values = Table_DevilFruitSniper,
    Multi = false,
    Default = 1
});
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    ...
    Description = "change premium fruit (if you have in shop)",
    Default = false
});
...
local v129 = v16.Fruit:AddToggle("ToggleCollect", {
    ...
    Description = "teleport to fruit spawn",
    Default = false
});
...
local v132 = v16.Fruit:AddToggle("ToggleEspIsland", {
    Title = "định vị Đảo",
    Description = "positioning island",
    Default = false
});
...
local v133 = v16.Fruit:AddToggle("ToggleEspFlower", {
    Title = "định vị Hoa",
    Description = "positioning follower",
    Default = false
});
...
local v134 = v16.Fruit:AddToggle("ToggleEspRealFruit", {
    ...
    Description = "positioning fruit to get kentrick v2",
    Default = false
});
...
local v137 = v16.Raid:AddDropdown("DropdownRaid", {
    ...
    Description = "choose chip to raid",
    Values = v136,
    Multi = false,
    Default = 1
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    ...
    Description = "auto raid and teleport to next island",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    ...
    Description = "gets fruit below 1m beli for doing raid",
    Default = false
});
...
if Sea2 then
    v16.Raid:AddButton({
        ...
        Description = "teleport to race raid",
        Callback = function()
            Tween2(CFrame.new(- 6438.73535, 250.645355, - 4501.50684));
        end
    });
elseif Sea3 then
    v16.Raid:AddButton({
        Title = "Bay Đến Chỗ Tập Kích",
        Description = "telport to place raid",
        Callback = function()
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(- 5075.50927734375, 314.5155029296875, - 3150.0224609375));
            Tween2(CFrame.new(- 5017.40869, 314.844055, - 2823.0127, - 0.925743818, 4.482175e-8, - 0.378151238, 4.5550315e-9, 1, 1.0737756e-7, 0.378151238, 9.768162e-8, - 0.925743818));
        end
...
v16.Misc:AddButton({
    Title = "rejoi sever",
    Description = "Tham Gia Máy Chủ Lại",
    Callback = function()
...
v16.Misc:AddButton({
    ...
    Description = "change to join marine",
    Callback = function()
...
v16.Misc:AddButton({
    ...
    Description = "xoá sương mù trong đảo bí ẩn",
    Callback = function()
        v152();
    end
});
...
v16.Sea:AddButton({
    ...
    Description = "Mua Chip Leviathan",
    Callback = function()
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    ...
    Description = "dịch chuyển đến đảo leviathan",
    Default = false
});
        ...
        pcall(function()
            while wait() do
                ...
                elseif (v811 == 0) then
                    ...
                    v561:SetDesc("buy: " .. tostring(v811));
                end
            end
        end);
    end);
...
v156:AddButton({
    ...
    Description = "teleport to get the dojo quest",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
        Tween2(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938));
    end
...
v156:AddButton({
    ...
    Description = "creator volcanic magnet",
    Callback = function()
        local v395 = {
            [1] = "CraftItem",
            [2] = "Craft",
